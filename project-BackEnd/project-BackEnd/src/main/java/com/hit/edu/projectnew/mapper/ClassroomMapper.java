...
//    public List<classroom> list();
    ...
    @Select("SELECT COUNT(*) FROM classroom WHERE CID = #{CID}")
    int countByClassroomId(Integer CID);
    @Select("SELECT * FROM classroom")
...
//                }
                ...
                if (conditions.get("CID") != null && conditions.get("CID") != "" ) {
                    WHERE("c.CID = #{CID}");
                }
                if (conditions.get("content") != null && conditions.get("content") != "" ) {
                    WHERE("c.content = #{content}");
                }
                if (conditions.get("building") != null && conditions.get("building") != "" ) {
                    WHERE("c.building = #{building}");
                }
                if (conditions.get("campus") != null && conditions.get("campus") != "" ) {
                    WHERE("c.campus = #{campus}");
                }
                if (conditions.get("occuTime") != null && conditions.get("occuTime") != "" ) {
                    WHERE("r.occuTime = #{occuTime}");
                }
                if (conditions.get("dateTime") != null && conditions.get("dateTime") != "" ) {
                    WHERE("r.dateTime = #{dateTime}");
                }
                if (conditions.get("occuStatus") != null && conditions.get("occuStatus") != "" ) {
                    WHERE("r.occuStatus = #{occuStatus}");
                }
                if (conditions.get("equipment") != null && conditions.get("equipment") != "" ) {
